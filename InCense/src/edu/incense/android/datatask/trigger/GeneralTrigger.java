...
public class GeneralTrigger extends DataTask implements InputEnabledTask  {
    ...
    public static final String[] textOperators = { "contains", "does not contain", "is", "is not", "starts with", "ends with" };
    public static final String[] numericOperators = { "is", "is not", "is greater than", "is less than", "is in the range" };
    public static final String[] dateOperators = { "is", "is not", "is after", "is before", "is in the last", "is not in the last", "is in the range" };
...
//        }
    ...
    protected void trigger(Data data){
        ...
        for(String surveyName: surveysToStart){
            ...
            Log.d(TAG, "Starting survey: " + surveyName);
        }
    ...
    protected void startSurvey(String surveyName){
        ...
        if (surveyName != null){
            surveyIntent.putExtra(SurveyService.SURVEY_NAME_FIELDNAME, surveyName);
    ...
    public boolean validate(Data data) {
        for (Condition c : conditions) {
            ...
            Log.i(c.getValue1() + "_b", String.valueOf(isValid));
...
//        }
    ...
    private boolean validateText(Data data, Condition condition) {
        ...
        if (condition.getOperator().compareTo(textOperators[0]) == 0) {
        	//Log.i(condition.getValue1(), String.valueOf(value.contains(String.valueOf(condition.getValue1()))));
        ...
        // Case "is"
        	...
        	//Log.i(condition.getValue1(), String.valueOf(value.compareTo(String.valueOf(condition.getValue1()))));
        ...
        // Case "ends with"
        	...
        	//Log.i(condition.getValue1(), String.valueOf(false));
        	return false;
        }
    }
